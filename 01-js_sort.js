...
// Rules are that TWO elements will be given to your function and your function
// must return -1, 0 or 1 according to wether element 1 is smaller equal or greater the elem2
...
function sortStudentsByLastName(student1, student2) {
    if(student1.lastName.length < student2.lastName.length ) return -1
    if(student1.lastName.length === student2.lastName.length) return 0
    if(student1.lastName.length > student2.lastName.length) return 1
}
...
function sortStudentsByAgeQuick(student1, student2) {
    return parseInt(student1.lastName) - parseInt(student2.lastName)
}

console.log("students by last name: ",students.sort(sortStudentsByAgeQuick))